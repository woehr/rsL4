...
CONFIG_HAVE_LIBC=y
CONFIG_HAVE_CRT=y
# CONFIG_LIB_SEL4_VKA is not set
CONFIG_LIB_CPIO=y
# CONFIG_LIB_ELF is not set
# CONFIG_LIB_SEL4_TEST is not set
# CONFIG_LIB_UTILS is not set
...
CONFIG_USER_CFLAGS=""
# CONFIG_BUILDSYS_USE_CCACHE is not set
# CONFIG_BUILDSYS_USE_GOANNA is not set
